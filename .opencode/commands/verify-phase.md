...
Perform a thorough code review of the PR branch code using the guidelines in @.opencode/commands/code-review.md. This includes:
...
- 🚫 **Changes required** — this will be included in the PR report for developer action
