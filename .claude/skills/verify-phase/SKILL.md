...
argument-hint: [path-to-phase-plan] [pr-url-or-number]
...
- Read [references/report-format.md](references/report-format.md) for PR comment and issue templates
...
Follow [references/report-format.md](references/report-format.md) for all templates and commands.
