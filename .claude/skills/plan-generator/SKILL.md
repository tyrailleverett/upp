...
Present a numbered list of phases before writing detailed plans. Read [references/phase-generation.md](references/phase-generation.md) for phase ordering and scoping guidance.
...
For each phase, read [references/plan-format.md](references/plan-format.md) and generate a plan following that format exactly. Critical rules:
